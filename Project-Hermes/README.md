...
```
Cryptography-Steganography-Project/ (Repository Root)
├── OOPS Capstone Project Presentation.pptx
├── README.md                          # System Documentation
└── Project-Hermes/                    # Project Directory
...
### Compilation
Navigate to the `Project-Hermes` folder and compile all project modules:
```powershell
cd Project-Hermes
...
### Execution
Navigate to the `Project-Hermes` folder, compile, and run the verification engine:
```powershell
cd Project-Hermes
